...
import { RequestError, field, formFields, originOf, readBody, spoolBody } from './http.js';
import { SECURITY_HEADERS, TONES, badge, empty, fail, html, jsonTag, page, raw, redirect, section, sendCsv, sendJson, sendPage, tile } from './views.js';
...
// The letters, and the one message this product sends by itself. Split out of this file — `docs/audit.md` §3 has
// the plan this is the first step of, and `src/notices.js` has the reasoning for the drafts being pure functions.
import { arrivalDraft, notifyPracticeOfChange, openingDraft, reminderDraft, signOff } from './notices.js';
...
// The head of a stored file: read by the upload path in that module, and by the replace route below.
