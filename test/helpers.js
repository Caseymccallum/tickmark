 ...
 */
export async function withServer(run, { maxUploadBytes, mailer, chaseBudgetMs, signInLimiter } = {}) {
  ...
  const server = createApp(db, { blobDir, maxUploadBytes, mailer, chaseBudgetMs, signInLimiter });
